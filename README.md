...
**ML/AI:** PyTorch, Transformers, RLlib  
**Systems:** Sockets, Consistent Hashing, RPC, Postgres  
**Frontend:** React, React Native, Tailwind  
**Cloud:** AWS, Docker  
**Other:** FastAPI, .NET, ROS, Gazebo, Solidity
...
💬 *Always open to collaborations, research ideas, or interesting engineering problems.*
